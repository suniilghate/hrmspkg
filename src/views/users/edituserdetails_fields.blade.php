...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('designation', $user_details->designation, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('city', $user_details->city, ['class' => 'form-control']) !!}
</div>

<!-- State Field -->
<div class="form-group col-sm-6">
    {!! Form::label('state', __('State').':') !!}
    {!! Form::text('state', $user_details->state, ['class' => 'form-control']) !!}
</div>

<!-- Country Field -->
<div class="form-group col-sm-6">
    {!! Form::label('country', __('Country').':') !!}
    {!! Form::text('country', $user_details->country, ['class' => 'form-control']) !!}
</div>
